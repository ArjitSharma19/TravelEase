    ...
    return `
      <div class="place-card" style="cursor: pointer;" data-place-index="${idx}">
        <div class="place-card-image-wrapper" style="height: 180px;">
          <img src="${escapeHTML(place.photoUrl || getPlaceFallbackImage(place.category, idx))}" class="place-card-img" alt="${escapeHTML(place.name)}" loading="lazy" onerror="this.onerror=null; this.src=getPlaceFallbackImage('${escapeHTML(place.category || '')}', ${idx});">
